 ...
 *
 * Trainee Fragment of the directory activity, as implemented by Michael
 */
public class TraineeFragment extends ListFragment{
    ...
    public void handleResponse() {
        ...
        if (mMemberData == null) {
            //note: refer to updateDisplayForError() method
    ...
    //the R file was not recognizing the error_title, error_message, and no_items, so I'd like to
    //come back to this one ASAP
